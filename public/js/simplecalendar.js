...
[]
    ...
    function setEvent() {
      $('.day-event').each(function(i) {
        eventMonth = $(this).attr('date-month');
        eventDay = $(this).attr('date-day');


      eventVenue= $(this).attr('data-venue');
      eventName= $(this).attr('date-name');
      eventCharges= $(this).attr('date-charges');
    ...
    function displayEvent() {
      $('tbody.event-calendar td').on('click', function(e) {
        ...
        var monthDay = $(this).attr('date-day');
        var monthVenue = $(this).data("venue");
        var monthCharges = $(this).attr("date-charges");
        var monthName = $(this).attr('date-name');

        var dayEvent = $(this).text();
        eName.value=eventName;
        eVenue.value=eventVenue;
        eCharges.value=eventCharges;
